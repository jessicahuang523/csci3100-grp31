...
import {Input, Button, Progress, Form, Media} from "reactstrap";
    ...
    return (
        <div style = {{display: "relative"}}>
            <Form onSubmit={handleUploadImage}>
                ...
                <Input id = "schedule" style = {{margin: "15px", width: "300px"}}
                       type="file"
            ...
            {url ? (
                <Media src={url} alt={image_main} style={{ width: "15rem", display: "inline-block", borderStyle: "outset",}} />
            ) : null}
            </div>
        </div>
    );
